...
Для выдачи файлов владельцу указывай ASCII-путь без пробелов (вне папки «3D печать»):
  python tools/edge_report.py --review-dir "%USERPROFILE%/web-sites/_review-3dprint"
